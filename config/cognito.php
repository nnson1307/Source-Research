...
return [
    ...
    */
    ...
    |
    */
    'default_user_group' => env('AWS_COGNITO_DEFAULT_USER_GROUP', "Users"),
    ...
    |
    */
    'add_missing_local_user_sso'    => env('AWS_COGNITO_ADD_LOCAL_USER', true),
    ...
    */
    ...
    |
    */
    'new_user_message_action' => env('AWS_COGNITO_NEW_USER_MESSAGE_ACTION', "SUPPRESS"),
];
